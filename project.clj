(defproject mdc-test "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "mdc-test.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.4-SNAPSHOT"]]}
             :uberjar {:aot [mdc-test.server]}}
  :main ^{:skip-aot true} mdc-test.server)
